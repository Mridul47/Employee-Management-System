...
id15.setLayout(null);
ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("oop_project/icons/add_employee.jpg"));
id15.setIcon(img);
...
if(ae.getSource() == b){
	   try {
           ...
           Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/employeedata", "root", "galacticos2001");
           ...
           st.executeUpdate();
           JOptionPane.showMessageDialog(f, "Employee Details registered succefully!");
