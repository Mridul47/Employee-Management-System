...
class Print_Data implements ActionListener{
    ...
    Print_Data(String e_id){
    	try {
    		...
    		.prepareStatement("select * from register where Employee_Id=?");
            ...
            while(rs.next()){
                ...
                aadhar = rs.getString("Citizenship_No");
        ...
        id9.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("oop_project/icons/print.jpg"));
        id9.setIcon(img);
