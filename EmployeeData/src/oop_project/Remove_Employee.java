...
class Remove_Employee implements ActionListener{
    ...
    Remove_Employee(){
        ...
        l5.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("oop_project/icons/remove.jpg"));
        l5.setIcon(img);
        f.add(l5);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            try{
        		...
        		.prepareStatement("select Name,Phone,Email_Id from register where Employee_Id = ?");
